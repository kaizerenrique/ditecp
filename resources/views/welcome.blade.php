        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <div class="ml-4 text-2xl leading-7 font-semibold">                        
                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Lorem ipsum dolor sit amet consectetur adipiscing elit risus, eros taciti tellus varius sem duis feugiat gravida, 
                                    suspendisse a nunc fringilla purus potenti nec. Potenti nibh habitasse gravida lectus morbi lacinia phasellus curabitur, 
                                    ridiculus aliquam auctor posuere dis vestibulum integer scelerisque, erat euismod montes suscipit ac mattis libero.
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="https://www.linkedin.com/in/oliverenriquegomez/" class="ml-1">
                                Desarrollado por Oliver Gómez
                            </a>
                        </div>
                    </div>
